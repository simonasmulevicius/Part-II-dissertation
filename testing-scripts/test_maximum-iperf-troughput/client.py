...
measurements_baseline  = perform_group_of_measurements(["taskset", "0x2", "ip", "netns", "exec", "mr_client"], [])
measurements_improved  = perform_group_of_measurements(["taskset", "0x2", "ip", "netns", "exec", "mr_client"], [])
