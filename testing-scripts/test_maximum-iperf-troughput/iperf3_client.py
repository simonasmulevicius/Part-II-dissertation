...
def perform_perf3_measurement(mtu):
    ...
    set_MTU(str(mtu))
    command_output = run_command_in_terminal(["taskset", "0x2", "iperf3", "-c", "127.0.0.1", "--udp", "-b", "0"])
...
MTUs = [100, 200, 400, 500, 750, 800, 900, 1000, 1100, 1200, 1300, 1400, 1500, 1600, 1750, 1800, 1900, 2000, 
