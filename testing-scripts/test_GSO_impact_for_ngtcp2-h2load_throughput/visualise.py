...
with open('summary_of_results.csv', 'w', newline='') as summary_of_results_file:
    ...
    results_writer.writerow(["results_folders", "delay_ms", "probability_of_loss_percentage", "payload_size", "clients_requests", 
        ...
        for probability_of_loss_percentage in [0]: #0.0001 0.001 0.01 0.1 1 
            for payload_size in [1000000, 10000000, 100000000, 1000000000]: #1000000000 # 10000000 100000000 1000000000
                for clients_requests in [1]:
                    for results_folders in ["no_gso_results", "with_gso_results"]:
                        ...
                        experiment_group_folder="./" + results_folders + "/" + group_experiment_description
                        ...
                        for experiment_number in range(1,number_of_experiments+1):
                            ...
                            with open(individual_experiment_folder+'/throughput_megabits_per_second.txt', 'r') as reader:
                                line = reader.readline()
                                throughput_megabits_per_second = float(line)
                        ...
                        results_writer.writerow([results_folders,
                            delay_ms, probability_of_loss_percentage, payload_size, clients_requests,
                            # min_completion_time_ms,              max_completion_time_ms,              
                            avg_completion_time_ms,              stdev_completion_time_ms,
